...
<head>
    ...
    <link rel="stylesheet" href="/CardioCompass/Styles/admin.css">
            ...
            <div class="user-side">
                <div class="dropdown">
                    ...
                    <div class="navdropdown-content">
                        <a href="/CardioCompass/admin-page/admin-account.php">Account</a>
...
<body>
                    ...
                    <div class="scrollable-table">
                        <table border="1">
                            ...
                            <?php
                                ...
                                // Fetch customer data using the modified getCustomers query
    ...
    function getCustomers($con)
    {
        $sql = "SELECT Customer.CustomerID, 
                       ...
                       Accounts.AccountID, 
                       AccData.AccountEmail, 
                       AccData.AccountUsername, 
                       AccData.AccountPass, 
                ...
                LEFT JOIN patient_form ON Customer.CustomerID = patient_form.patient_id
                ORDER BY Accounts.AccountID ASC";
